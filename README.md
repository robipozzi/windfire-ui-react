...
Windfire is designed to integrate different software components in a flexible and future-proof manner.

## Architecture

The Windfire system currently consists of two client UIs that share a centralized Keycloak authentication backend.
